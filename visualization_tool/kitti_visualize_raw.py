...
class kitti_object_sparse(object):
    '''Load and parse object data into a usable format.'''
    def __init__(self, root_dir, sparse_dir, args=None):
        ...
        self.split_dir = os.path.join(
            root_dir, self.split)  # args.dir/split('training'/'testing')
        self.sparse_split_dir = os.path.join(sparse_dir, self.split)
        if self.split == 'training':
            self.num_samples = 7481
        elif self.split == 'testing':
            self.num_samples = 7518
        ...
        # self.lidar_dir_seq = os.path.join(
        #     os.path.join(self.split_dir, lidar_dir), seq_id)
        self.lidar_dir = os.path.join(self.sparse_split_dir, lidar_dir)
        self.lidar_dir_seq = os.path.join(
            os.path.join(self.sparse_split_dir, lidar_dir), seq_id)
        self.depth_dir = os.path.join(os.path.join(self.split_dir, depth_dir),
                                      seq_id)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-spd',
                        '--sparse_dir',
                        type=str,
                        default="../sparse_lidar_results/4channel",
                        metavar='N',
                        help='input  (default: data/object)')
